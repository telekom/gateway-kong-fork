  ...
  fields = {
    { config = {
        ...
        fields = {
          ...
          { header_type = { type = "string", required = true, default = "preserve", one_of = { "preserve", "b3", "b3-single", "w3c", "jaeger", "ot" } } },
          { default_header_type = { type = "string", required = true, default = "b3", one_of = { "b3", "b3-single", "w3c", "jaeger", "ot" } } },
